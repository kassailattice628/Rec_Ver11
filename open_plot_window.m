...
%% %---------- Create plot window ----------%
%open plot window
hGui.fig = figure('Position',[sobj.GUI_Display_x+650, 20, 630, 750], 'Name','Plot Window NBA11', 'NumberTitle', 'off', 'Menubar','none', 'Resize', 'off');
...
if Recmode == 1
    % Vertical position
    hGui.axes1_1 = axes('Units','Pixels', 'Position',[50,600,500,130], 'XLimMode', 'manual','YlimMode', 'Auto');
    hGui.plot1_1 = plot(0, NaN(1,2));
    set(gca, 'xticklabel',[])
    ylabel('Vertical (V)');
    hGui.button1_1 = uicontrol('style','togglebutton','string', 'ON', 'position',[555 700 45 30],...
        'callback', {@ch_ButtonColor, 'g'}, 'Horizontalalignment','center');
    set(hGui.button1_1,'value',1, 'BackGroundColor','g')
    
    % Horizontal position
    hGui.axes1_2 = axes('Units','Pixels', 'Position',[50,450,500,130], 'XLimMode', 'manual','YlimMode', 'Auto');
    hGui.plot1_2 = plot(0, NaN(1,2));
    set(gca, 'xticklabel',[])
    ylabel('Horizontal (V)');
    hGui.button1_2 = uicontrol('style','togglebutton','string', 'ON', 'position',[555 550 45 30],...
        'callback', {@ch_ButtonColor, 'g'}, 'Horizontalalignment','center');
    set(hGui.button1_2,'value',1, 'BackGroundColor','g')
...
%%%%%%%%%%%%     Photosensor    %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
hGui.axes2 = axes('Units','Pixels', 'Position',[50,330,500,100], 'XLimMode', 'manual','YlimMode', 'Auto');
hGui.plot2 = plot(0, NaN);
set(gca, 'xticklabel',[])
ylabel('Photo Sensor (V)');

hGui.button2 = uicontrol('style','togglebutton','string', 'ON', 'position',[555 400 45 30],...
    'callback', {@ch_ButtonColor, 'g'}, 'Horizontalalignment','center');
...
%%%%%%%%%%%%   Rotary Encoder   %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
hGui.axes3 = axes('Units','Pixels', 'Position',[50,210,500,100], 'XLimMode', 'manual','YlimMode', 'Auto');
hGui.plot3 = plot(0, NaN);
xlabel('Time (s)');
ylabel('Rotary Angle (deg)');

hGui.button3 = uicontrol('style','togglebutton','string', 'ON', 'position',[555 280 45 30],...
    'callback', {@ch_ButtonColor, 'g'}, 'Horizontalalignment','center');
